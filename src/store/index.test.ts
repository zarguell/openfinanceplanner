...
describe('exportState', () => {
  ...
  it('should generate filename with current date format', () => {
    ...
    const createElement = globalThis.document.createElement as ReturnType<typeof vi.fn>
  ...
  it('should create and click anchor element', () => {
    ...
    const createElement = globalThis.document.createElement as ReturnType<typeof vi.fn>
    const mockBody = globalThis.document.body as unknown as { appendChild: ReturnType<typeof vi.fn>; removeChild: ReturnType<typeof vi.fn> }
  ...
  it('should revoke object URL to prevent memory leaks', () => {
    ...
    const revokeObjectURL = globalThis.URL.revokeObjectURL as ReturnType<typeof vi.fn>
...
describe('importState', () => {
  ...
  it('should throw on null data', async () => {
    ...
    await expect(importState(file)).rejects.toThrow('Invalid file format: not an object')
  })
