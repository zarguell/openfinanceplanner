  ...
  DC: {
    brackets: {
      single: [
        ...
        { rate: 0.1075, min: 100000001, max: null },
      ],
      married_joint: [
        { rate: 0.04, min: 0, max: 1000000 },
        { rate: 0.06, min: 1000001, max: 4000000 },
  ...
  CA: {
    brackets: {
      single: [
        ...
        { rate: 0.123, min: 74295301, max: null },
      ],
      married_joint: [
        ...
        { rate: 0.123, min: 148590601, max: null },
      ],
      married_separate: [
        { rate: 0.01, min: 0, max: 1107900 },
        { rate: 0.02, min: 1107901, max: 2626400 },
    ...
    standardDeduction: {
      single: 5272000,
      married_joint: 10544000,
      married_separate: 5272000,
      head_of_household: 7944000,
    },
  },
  NY: {
    brackets: {
      single: [
        ...
        { rate: 0.109, min: 500000001, max: null },
      ],
      married_joint: [
        ...
        { rate: 0.109, min: 1000000001, max: null },
      ],
      married_separate: [
        { rate: 0.04, min: 0, max: 8500000 },
        { rate: 0.045, min: 8500001, max: 11700000 },
      ...
      head_of_household: [
        ...
        { rate: 0.109, min: 750000001, max: null },
      ],
    },
    standardDeduction: {
      single: 8000000,
      married_joint: 16000000,
      married_separate: 8000000,
      head_of_household: 12000000,
    },
  },
};
