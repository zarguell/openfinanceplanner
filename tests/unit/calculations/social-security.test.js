...
export function testCalculateFullRetirementAge() {
  ...
  if (result1960.years !== 67 || result1960.months !== 0) {
    throw new Error(
      `Expected FRA of 67 years 0 months for birth year 1960, got ${result1960.years} years ${result1960.months} months`
    );
  }
  ...
  if (result1937.years !== 65 || result1937.months !== 0) {
    throw new Error(
      `Expected FRA of 65 years 0 months for birth year 1937, got ${result1937.years} years ${result1937.months} months`
    );
  }
  ...
  if (result1959.years !== 66 || result1959.months !== 10) {
    throw new Error(
      `Expected FRA of 66 years 10 months for birth year 1959, got ${result1959.years} years ${result1959.months} months`
    );
  }
  ...
  if (result1954.years !== 66 || result1954.months !== 0) {
    throw new Error(
      `Expected FRA of 66 years 0 months for birth year 1954, got ${result1954.years} years ${result1954.months} months`
    );
  }
...
export function testCalculateSocialSecurityForYear() {
  ...
  const incomeBeforeRetirement = calculateSocialSecurityForYear(
    socialSecurity,
    3,
    currentAge,
    retirementAge,
  ...
  const incomeAfterFiling = calculateSocialSecurityForYear(
    socialSecurity,
    8,
    currentAge,
    retirementAge,
