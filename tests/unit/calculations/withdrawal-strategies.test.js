...
export function testProportionalStrategy() {
  ...
  console.assert(
    withdrawals2[0] === 1000000,
    'Test 2a failed: IRA should withdraw 50% = $10,000'
  );
  console.assert(
    withdrawals2[1] === 750000,
    'Test 2b failed: 401k should withdraw 37.5% = $7,500'
  );
  console.assert(
  ...
  console.assert(
    withdrawals3[0] === 1000000,
    'Test 3 failed: 401k should withdraw all $10,000'
  );
  console.assert(
    withdrawals3[1] === 500000,
    'Test 3 failed: Roth should withdraw all $5,000'
  );
...
export function testTaxEfficientStrategy() {
  ...
  console.assert(
    withdrawals2[0] === 300000,
    'Test 2a failed: Taxable should withdraw all $3,000'
  );
  console.assert(
    withdrawals2[1] === 1200000,
    'Test 2b failed: IRA should withdraw $12,000'
  );
  console.assert(
    withdrawals2[2] === 0,
    'Test 2c failed: Roth should not withdraw'
  );
  ...
  console.assert(
    withdrawals3[0] === 200000,
    'Test 3a failed: Taxable should withdraw $2,000'
  );
  console.assert(
...
export function testTaxAwareStrategy() {
  ...
  console.assert(
    withdrawals[0] === 500000,
    'Test 1a failed: Taxable should withdraw $5,000 first'
  );
  console.assert(
    withdrawals[1] === 0,
    'Test 1b failed: IRA should not withdraw'
  );
...
export function testCalculateWithdrawals() {
  ...
  console.assert(
    withdrawals1[0] === 166667,
    'Test 1a failed: Proportional strategy should work'
  );
  console.assert(
    withdrawals1[1] === 333333,
    'Test 1b failed: Proportional strategy should work'
  );

  // Test tax-efficient strategy
  const withdrawals2 = calculateWithdrawals('tax-efficient', accounts, 500000);
  console.assert(
    withdrawals2[0] === 500000,
    'Test 2a failed: Tax-efficient strategy should work'
  );
  console.assert(
    withdrawals2[1] === 0,
    'Test 2b failed: Tax-efficient strategy should work'
  );

  // Test tax-aware strategy
  const withdrawals3 = calculateWithdrawals('tax-aware', accounts, 500000, []);
  console.assert(
    withdrawals3[0] === 500000,
    'Test 3a failed: Tax-aware strategy should work'
  );
  console.assert(
    withdrawals3[1] === 0,
    'Test 3b failed: Tax-aware strategy should work'
  );
